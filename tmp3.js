...
if (startIdx !== -1) {
  let depth = 1;
  let endIdx = startIdx + radarStart.length;
  // Let's just find the next </article> since there are no nested <article> tags inside it.
  endIdx = c.indexOf(radarEndMatch, endIdx);
  if (endIdx !== -1) {
